...
* Add comment to force version bump ([0a24ecd](https://github.com/devkindhq/swell-mcp/commit/0a24ecdbbbda914a24188b6665d6c15d4c026245))
* add GEMINI_API_KEY to Execute Gemini CLI step env ([b4a7959](https://github.com/devkindhq/swell-mcp/commit/b4a7959fa7dba467d77d9576c9d4cdb729620ac4))
* add workflows permission to semantic-release workflow ([de3a335](https://github.com/devkindhq/swell-mcp/commit/de3a33510bd447af353444db1fcb58e1b1aa02e4))
* Align CLI options and descriptions with style guide ([0f5f490](https://github.com/devkindhq/swell-mcp/commit/0f5f4901f69ea80d03688b289b0cd59599957740))
* align ipaddress CLI descriptions with tool/schema ([1eeaeeb](https://github.com/devkindhq/swell-mcp/commit/1eeaeeb8ee4bd425abe135cb4d2717278e7aa617))
* align README tool example with concise description style ([b8126a4](https://github.com/devkindhq/swell-mcp/commit/b8126a4b4f8286cfefeb9c50f53aaea7e9f90982))
* allow Gemini to run even if build fails to catch PR issues ([c7b31b3](https://github.com/devkindhq/swell-mcp/commit/c7b31b33674b4ef458d6d201aa22673f13a5247a))
* apply prettier formatting to index.ts ([b416d81](https://github.com/devkindhq/swell-mcp/commit/b416d81f62e307371615b382aa997d52cd8903b8))
* change default transport from HTTP to STDIO for proper MCP client integration ([05027b8](https://github.com/devkindhq/swell-mcp/commit/05027b8320ea52926527b030a085fc2f754149eb))
* correct TypeScript errors in transport utility ([573a7e6](https://github.com/devkindhq/swell-mcp/commit/573a7e63e1985aa5aefd806c0902462fa34c14d7))
* debug GEMINI_API_KEY availability in workflow ([20581bd](https://github.com/devkindhq/swell-mcp/commit/20581bdde13d0b8306c665c2619f5f6dccccfb5a))
* **deps:** update dependencies to latest versions ([97baabe](https://github.com/devkindhq/swell-mcp/commit/97baabeb2477fe8ce5e815fa55d8873f44e3ca11))
* ensure executable permissions for bin script ([395f1dc](https://github.com/devkindhq/swell-mcp/commit/395f1dcb5f3b5efee99048d1b91e3b083e9e544f))
* handle empty strings properly in greet function ([546d3a8](https://github.com/devkindhq/swell-mcp/commit/546d3a84209e1065af46b2213053f589340158df))
* Improve cross-platform compatibility for npx execution ([d840c51](https://github.com/devkindhq/swell-mcp/commit/d840c51cc94ad3d54e5c38670b774cdb7d52b8a7))
* improve error logging with IP address details ([121f516](https://github.com/devkindhq/swell-mcp/commit/121f51655517ddbea7d25968372bd6476f1b3e0f))
* improve GitHub Packages publishing with a more robust approach ([fd2aec9](https://github.com/devkindhq/swell-mcp/commit/fd2aec9926cf99d301cbb2b5f5ca961a6b6fec7e))
* improve GitHub Packages publishing with better error handling and debugging ([db25f04](https://github.com/devkindhq/swell-mcp/commit/db25f04925e884349fcf3ab85316550fde231d1f))
* improve GITHUB_OUTPUT syntax in semantic-release workflow ([6f154bc](https://github.com/devkindhq/swell-mcp/commit/6f154bc43f42475857e9256b0a671c3263dc9708))
* improve signal handling for npx support ([72634a8](https://github.com/devkindhq/swell-mcp/commit/72634a85fea332e4551dd273d29df8217f24309d))
* improve version detection for global installations ([97a95dc](https://github.com/devkindhq/swell-mcp/commit/97a95dca61d8cd7a86c81bde4cb38c509b810dc0))
* Log package name and version on startup ([b4534db](https://github.com/devkindhq/swell-mcp/commit/b4534db227ba0e3dd7cc6b82207457b98c7030d0))
* **logger:** ensure consistent logger implementation across all projects ([ec37c74](https://github.com/devkindhq/swell-mcp/commit/ec37c74ec75cc3eaf09042e51213c27145cf8f44))
* **logging:** ensure consistent logger implementation across projects ([253323e](https://github.com/devkindhq/swell-mcp/commit/253323e4d351a82ac3358140441c77b9d9b540bd))
* make publish workflow more resilient against version conflicts ([ffd3705](https://github.com/devkindhq/swell-mcp/commit/ffd3705bc064ee9135402052a0dc7fe32645714b))
* Manually set version to 1.6.1 to resolve release conflict ([a96c37b](https://github.com/devkindhq/swell-mcp/commit/a96c37b4ee599b1847237cba5bb8947265c563fa))
* name changes ([edf46d9](https://github.com/devkindhq/swell-mcp/commit/edf46d9bad5a94f5fe6b180f26ba54644ebff666))
* pass GEMINI_API_KEY to gemini CLI command ([a9dd9d7](https://github.com/devkindhq/swell-mcp/commit/a9dd9d7300e6a9171e52dd11eba551c60ec95c04))
* Refactor IP address controller to accept args as a single object ([acb7ea2](https://github.com/devkindhq/swell-mcp/commit/acb7ea2a148e9673a4bf2aa703f8ca988dc05c93))
* Refactor types using Zod and restore resources ([4965bd2](https://github.com/devkindhq/swell-mcp/commit/4965bd2d4c301baf6a5c10b40893f7028b849a7e))
* remove debug logging from Gemini workflow ([6f176fe](https://github.com/devkindhq/swell-mcp/commit/6f176feef9a047d3a1fda99983cf1fafb01e93ad))
* remove Dockerfile and smithery.yaml ([582e9f9](https://github.com/devkindhq/swell-mcp/commit/582e9f9e66087fd2211d6fcf1aaa79c9ee54a123))
* remove invalid workflows permission ([c012e46](https://github.com/devkindhq/swell-mcp/commit/c012e46a29070c8394f7ab596fe7ba68c037d3a3))
* Remove re-exports from index.ts ([5175dcf](https://github.com/devkindhq/swell-mcp/commit/5175dcfa2870bc5971a3d28da237aafb640b3b31))
* remove type module to fix CommonJS compatibility ([8b1f00c](https://github.com/devkindhq/swell-mcp/commit/8b1f00c37467bc676ad8ec9ab672ba393ed084a9))
* Remove unused exports identified by ts-prune ([c9fdc7d](https://github.com/devkindhq/swell-mcp/commit/c9fdc7d8cb58cd79d83346655d9f8cf29a10fc27))
* removing stockLevel ([75c37c1](https://github.com/devkindhq/swell-mcp/commit/75c37c117394322d8838943d09c507dddb9679d0))
* rename IP tool to 'ip_get_details' for naming consistency ([fb2a5c6](https://github.com/devkindhq/swell-mcp/commit/fb2a5c6df0766f608e5e06f6f13326a4821e6760))
* replace Unix-specific chmod with cross-platform ensure-executable script ([6733798](https://github.com/devkindhq/swell-mcp/commit/6733798669eead4766627193d5ef9f1f0cf1582a))
* resolve linter errors in version detection code ([5f1f33e](https://github.com/devkindhq/swell-mcp/commit/5f1f33e88ae843b7a0d708899713be36fcd2ec2e))
* resolve TypeScript compilation errors and improve compatibility ([873c3f6](https://github.com/devkindhq/swell-mcp/commit/873c3f63c4ec384ffa13adf94b54f6b6bb4fdbdc))
* resolve TypeScript/ESLint version conflict and linting issues ([fa0486a](https://github.com/devkindhq/swell-mcp/commit/fa0486adb67fa449fa038937fb56521f877d4ad4))
* Revert back the index.ts and package.json ([74c6e08](https://github.com/devkindhq/swell-mcp/commit/74c6e08c058d09f6e885134197cbf90d47e0ccc7))
* revert zod to v3.25.67 for consistency across MCP projects ([6d6ed1c](https://github.com/devkindhq/swell-mcp/commit/6d6ed1ccdac15eb8595fffd4eb14162a998e183c))
* standardize index.ts entrypoint logic and package bin ([7f9aaf0](https://github.com/devkindhq/swell-mcp/commit/7f9aaf051cf3d4d92971892e21e32e23820be90b))
* stock update ([ed22089](https://github.com/devkindhq/swell-mcp/commit/ed22089cab3c951610a311127243c4a9c2aa01c3))
* stock update version ([6b4fc7d](https://github.com/devkindhq/swell-mcp/commit/6b4fc7d97c992bf3791f40af465481d215ef8dce))
* swell tooling ([e6f4b62](https://github.com/devkindhq/swell-mcp/commit/e6f4b62f52f08e147dabd9d749c0b3b235e2e514))
* trigger release ([9abd0cc](https://github.com/devkindhq/swell-mcp/commit/9abd0cc8fb28f9d8c430edb76833db2b4c825b3f))
* trying package update via token ([c8eaa5f](https://github.com/devkindhq/swell-mcp/commit/c8eaa5fc4fba2503d0a528217d95c7bd1a5f9b42))
* unify tool description for clarity and consistency ([006460b](https://github.com/devkindhq/swell-mcp/commit/006460bacd1413b3254e45c6085b07f27a468898))
* update dependencies ([fcd9de0](https://github.com/devkindhq/swell-mcp/commit/fcd9de082f648db2bb6e74a04e91c0595f1bb28a))
* update dependencies ([374094d](https://github.com/devkindhq/swell-mcp/commit/374094d252c5fe008ac09421b303cdc08837872e))
* update dependencies ([02c42fa](https://github.com/devkindhq/swell-mcp/commit/02c42fa6ef66be461444d1780b013860b455cbff))
* update dependencies ([1340085](https://github.com/devkindhq/swell-mcp/commit/1340085d8476f92e72e7afe248a86f50e0b4ff84))
* update dependencies ([88fa27c](https://github.com/devkindhq/swell-mcp/commit/88fa27c0e67d97a83d780f0aa99255979e139bb7))
* update dependencies ([e211b19](https://github.com/devkindhq/swell-mcp/commit/e211b19e18ae40123d0f609aaac854f4fb325800))
* Update dependencies and fix related type errors ([dfdec0a](https://github.com/devkindhq/swell-mcp/commit/dfdec0a1e314b96fa76000058bc7d48efd2c9dee))
* update examples to use correct API (greet instead of sayHello) ([7c062ca](https://github.com/devkindhq/swell-mcp/commit/7c062ca42765c659f018f990f4b1ec563d1172d3))
* update function references from register to registerTools and registerResources ([393cff2](https://github.com/devkindhq/swell-mcp/commit/393cff298f7ddafb6a927b882d5731aa924df783))
* update release workflow to ensure correct versioning in compiled files ([a365394](https://github.com/devkindhq/swell-mcp/commit/a365394b8596defa33ff5a44583d52e2c43f0aa3))
* update version display in CLI ([2b7846c](https://github.com/devkindhq/swell-mcp/commit/2b7846cbfa023f4b1a8c81ec511370fa8f5aaf33))
* updating doc ([1eb3b42](https://github.com/devkindhq/swell-mcp/commit/1eb3b42e82a88256f2bfa10fa900878105c5fa3a))
* version upgrade ([36c9999](https://github.com/devkindhq/swell-mcp/commit/36c999947231175ef1cb948e024fbb7a45f829d0))


### Features

* add automated dependency management ([efa1b62](https://github.com/devkindhq/swell-mcp/commit/efa1b6292e0e9b6efd0d43b40cf7099d50769487))
* add CLI usage examples for both JavaScript and TypeScript ([d5743b0](https://github.com/devkindhq/swell-mcp/commit/d5743b07a6f2afe1c6cb0b03265228cba771e657))
* add customer update ([0022e15](https://github.com/devkindhq/swell-mcp/commit/0022e15eb5c6e8b2622293ab3b5a4114949b26d7))
* add gitignore ([29625c7](https://github.com/devkindhq/swell-mcp/commit/29625c7e296e7eb449a2b39d849ed05a998176e7))
* add startup logging with package name and version ([cb09d0f](https://github.com/devkindhq/swell-mcp/commit/cb09d0f1fa7ffc252f7c4370553f448e7fbfc44e))
* add Streamable HTTP transport support alongside STDIO ([aa04e01](https://github.com/devkindhq/swell-mcp/commit/aa04e011b2f80ced3de024050e36ef09d3ed7b18))
* add support for custom name in greet command ([be48a05](https://github.com/devkindhq/swell-mcp/commit/be48a053834a1d910877864608a5e9942d913367))
* add version update script and fix version display ([ec831d3](https://github.com/devkindhq/swell-mcp/commit/ec831d3a3c966d858c15972365007f9dfd6115b8))
* **boilerplate:** add standard pagination utils and formatPagination ([cb1e004](https://github.com/devkindhq/swell-mcp/commit/cb1e004fcb33eef61605983b74cf8a373018830b))
* **boilerplate:** improve version handling and module exports ([faa1713](https://github.com/devkindhq/swell-mcp/commit/faa17138ccb1b943197ae91b37a54527481ffbca))
* enhanced error handling across the application ([75aa905](https://github.com/devkindhq/swell-mcp/commit/75aa90528e615d1c1a9a411ddd1bf1931edfde61))
* implement Gemini CLI autonomous MCP engineer ([cb632bd](https://github.com/devkindhq/swell-mcp/commit/cb632bd8be5ce84425743da6250c4b45816c76be))
* implement review recommendations ([a23cbc0](https://github.com/devkindhq/swell-mcp/commit/a23cbc0608a07e202396b3cd496c1f2078e304c1))
* implement testing, linting, and semantic versioning ([1d7710d](https://github.com/devkindhq/swell-mcp/commit/1d7710dfa11fd1cb04ba3c604e9a2eb785652394))
* improve CI workflows with standardized Node.js version, caching, and dual publishing ([0dc9470](https://github.com/devkindhq/swell-mcp/commit/0dc94705c81067d7ff63ab978ef9e6a6e3f75784))
* improve development workflow and update documentation ([4458957](https://github.com/devkindhq/swell-mcp/commit/445895777be6287a624cb19b8cd8a12590a28c7b))
* improve ip_get_details tool description and CLI usability with short options ([895feeb](https://github.com/devkindhq/swell-mcp/commit/895feeb7ef23252ba32023cde658feaa9fd382d8))
* improve package structure and add better examples ([bd66891](https://github.com/devkindhq/swell-mcp/commit/bd668915bde84445161cdbd55ff9da0b0af51944))
* initial mcp server ([c5f5414](https://github.com/devkindhq/swell-mcp/commit/c5f5414ef5d304b3b346ad8e6ee011f06bea558e))
* **logging:** add file logging with session ID to ~/.mcp/data/ ([0448918](https://github.com/devkindhq/swell-mcp/commit/0448918908b6bd3d56cec94fdf768d2410973631))
* modernize dependencies and enhance testing infrastructure ([#67](https://github.com/devkindhq/swell-mcp/issues/67)) ([a74f114](https://github.com/devkindhq/swell-mcp/commit/a74f1145b7e80615a9a0c907b9d19eb5e4fbd2e8))
* refactor ControllerResponse to only include content field ([68118c7](https://github.com/devkindhq/swell-mcp/commit/68118c75e4fcbe759140807a8d65e583e85b9535))
* refactor services to use live API tests and remove timeout parameter ([3c483b4](https://github.com/devkindhq/swell-mcp/commit/3c483b4379dfcdf47d29cd94903265393b831187))
* Support multiple keys for global config lookup ([49c26f1](https://github.com/devkindhq/swell-mcp/commit/49c26f16d6f8c1baa29097c213e6fcfc65f5c809))
* update dependencies ([3f61427](https://github.com/devkindhq/swell-mcp/commit/3f614270f136e03548d05a4d2dfff24769798ff6))
* updating package description ([1a9a7ab](https://github.com/devkindhq/swell-mcp/commit/1a9a7abc7942474412f07c09c9f3177cc88fdf3c))


### Performance Improvements

* **core:** refactor code structure to align with Atlassian MCP patterns ([090fd56](https://github.com/devkindhq/swell-mcp/commit/090fd5653ab62d70eb75c49828a9876f54cee6fc))
* **ipaddress:** enhance formatter output and optimize service implementation ([f1ccdbf](https://github.com/devkindhq/swell-mcp/commit/f1ccdbf58cb2518ca979363369904255e5de275b))
* **standards:** align codebase with Atlassian MCP server patterns ([8b8eb13](https://github.com/devkindhq/swell-mcp/commit/8b8eb13fd4ce18158e83c4f8c7044ce06287f23e))
* **tests:** add CLI test infrastructure and ipaddress tests ([ccee308](https://github.com/devkindhq/swell-mcp/commit/ccee308a86e076a67756e9113b481aa3848f40b7))
* Update dependencies ([ee33a4c](https://github.com/devkindhq/swell-mcp/commit/ee33a4cc170750594cb0c9417898a29030029943))
* Update dependencies ([469a400](https://github.com/devkindhq/swell-mcp/commit/469a4002b7af8f6f3750b55e2b076d8ef7a2ab6e))
* Update dependencies ([585fe31](https://github.com/devkindhq/swell-mcp/commit/585fe31c667c51b93f2f11a50a4b438815603f1a))
* Update dependencies ([cbc63fe](https://github.com/devkindhq/swell-mcp/commit/cbc63fe692f563a3e1b68bb136b8f567408fbf9c))
* Update dependencies ([d5653b8](https://github.com/devkindhq/swell-mcp/commit/d5653b8e31581e3bffe9d5b1d891afd58dee6f3b))
* Update dependencies ([b35601d](https://github.com/devkindhq/swell-mcp/commit/b35601d40e70384fb0c1743a09831a7e1ea704e5))
* Update dependencies ([b0c4046](https://github.com/devkindhq/swell-mcp/commit/b0c4046f29d3ec31a1b9c40734c683065525bf56))
* Update dependencies ([6f6ed3e](https://github.com/devkindhq/swell-mcp/commit/6f6ed3ea73059594bda242910ca7d3b361d7e690))
* **utils:** implement standardized core utilities and error handling ([6c14a2f](https://github.com/devkindhq/swell-mcp/commit/6c14a2f83397f79cc39f0b7ec70b40e9d9755b9c))


### Reverts

* restore simple version handling ([bd0fadf](https://github.com/devkindhq/swell-mcp/commit/bd0fadfa8207b4a7cf472c3b9f4ee63d8e36189d))
